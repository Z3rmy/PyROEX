        ...
        for tag in self.OCC_OPE_S:
            ...
            if index_ == 0 :
                ...
                for key in related_keys:
                    if key in self.OCC_OPE_str:
                        # 转换为float64类型
                        self.OCC_OPE_filter[key] = np.array(self.OCC_OPE_filter[key], dtype=np.float64)
                        # 填充NaN
                        self.OCC_OPE_filter[key][:] = np.nan
...
if __name__ == "__main__":   
    ...
    filename=r"C:/Users/zhangmingyi24/OneDrive/Desktop/ROEX分析软件开源程序论文/atmRox_BDS_2024.152/atmRox_BDS_2024.152/cloAtm_GNOS.007.C06.40.2024.152.44063.0139.01.0000_bin.ROX"
    test =Atm_File()
